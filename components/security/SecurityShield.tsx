// SecurityShield.tsx
// Real-Time Status Engine for the Zipd Security
// Obsidian Glass + Gold Filament visual grammar

import { motion, AnimatePresence } from "framer-motion";
import { SecurityState } from "@/lib/security/edge/SecurityEngine";
...
const stateMetadata: Record<SecurityState, {
  label: string;
...
export const SecurityShield = ({ state, onDenialDismiss }: SecurityShieldProps) => {
        ...
        {isDenied && (
          ...
          >
            <p className="font-serif text-sm tracking-wider text-red-400/80 text-center max-w-xs">
              Biometric verification declined. This destination requires security identity confirmation.
            </p>
            <button

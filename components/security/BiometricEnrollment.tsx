...
// The Security Enrollment Ceremony UI
// Requires hardware enclave verification to claim the identity

import { motion } from "framer-motion";
import { ShieldCheck, Fingerprint, Key, Loader } from "lucide-react";

type EnrollmentStatus = "idle" | "preparing" | "waiting" | "verifying" | "success" | "failed";
...
const statusConfig: Record<EnrollmentStatus, {
  ...
  idle: {
    ...
    label: "Security Enrollment",
    subtext: "Verify hardware enclave to secure identity",
  },
  preparing: {
  ...
  success: {
    ...
    subtext: "Security identity confirmed",
  },
  failed: {
...
export const BiometricEnrollment = ({ onInitiate, status, errorMessage }: BiometricEnrollmentProps) => {

...
// Edge-side Credential Management for Security Enrollment
...
export class CredentialManager {
  private readonly RP_ID = 'zipd.security';
  ...
  async verifyEnrollment(
    ...
    if (!expectedChallenge) {
      throw new Error('AUTH_FAILED: No active challenge found.');
    }
    ...
    throw new Error('AUTH_FAILED: Identity could not be verified.');
  }

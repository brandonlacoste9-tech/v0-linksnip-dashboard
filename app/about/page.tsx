      ...
      <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
        <div className="mb-12">
          ...
          <p className="text-xl text-amber-500/80 font-light">
            The sovereign URL management platform.
          </p>
        </div>
        ...
        <div className="space-y-12">
          ...
          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            ...
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">To provide enterprises with total ownership and control over their digital touchpoints.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Our Story</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">Founded out of frustration with rented infrastructure, LinkSnip was built to be owned, not leased.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Leadership</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">Led by veterans in cloud infrastructure and cybersecurity.</p>
          </section>
        </div>

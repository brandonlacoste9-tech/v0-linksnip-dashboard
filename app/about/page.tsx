      ...
      <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
        ...
        <div className="space-y-12">
          ...
          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            ...
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">Founded out of frustration with rented infrastructure, Zipd was built to be owned, not leased. Our mission is to provide every brand with their own private, high-performance link network.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">The Team</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">Built by Northern Ventures / Moltbot Inc. in Canada. We are engineers obsessed with edge performance and data sovereignty.</p>
          </section>
        </div>

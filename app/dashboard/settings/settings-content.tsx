      ...
      <header className="h-20 border-b border-white/5 bg-[#0d1221]/80 backdrop-blur-xl flex items-center justify-between px-8 shrink-0 z-20 shadow-imperial">
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-[10px] text-zinc-500 uppercase tracking-[0.2em] font-medium mt-0.5">Access Control Management</p>
          </div>
        </div>
      </header>
          ...
          <Card className="glass-navy border-[#c9a84c]/20 bg-[#c9a84c]/5 rounded-2xl overflow-hidden shadow-imperial relative group">
            ...
            <CardContent className="p-8 flex gap-6 items-start relative z-10">
              ...
              <div className="space-y-2">
                <h3 className="text-lg font-bold text-[#e5c76b] tracking-tight">Security Protocol Enforcement</h3>
                <p className="text-sm text-zinc-400 leading-relaxed max-w-2xl">
                  Define the inner circle of your Zipd instance. Authorized identities gain full administrative rights over redirection sequences and click telemetry. 
                  Master identities defined via <code className="text-[#c9a84c] bg-[#c9a84c]/10 px-1.5 py-0.5 rounded font-mono text-[11px]">AUTHORIZED_USER_IDS</code> inherit permanent authority.
                </p>
              </div>
            </CardContent>
          </Card>
            ...
            <Card className="lg:col-span-3 glass-navy border-white/5 rounded-2xl shadow-imperial">
              <CardHeader className="flex flex-row items-center justify-between border-b border-white/5 mb-6">
                <div>
                  ...
                  <CardDescription className="text-zinc-500 text-xs mt-2">Identities with verified database authority.</CardDescription>
                </div>
                  ...
                  {loading ? (
                    ...
                    <div className="py-20 text-center space-y-6 border-2 border-dashed border-white/5 rounded-3xl group hover:border-[#c9a84c]/20 transition-all duration-700">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-xs text-zinc-600 max-w-[200px] mx-auto">No external identities have been granted authority over this instance yet.</p>
                      </div>
                    </div>
                  )}
                </div>

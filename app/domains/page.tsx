      ...
      <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
        ...
        <div className="space-y-12">
          ...
          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Multiple Domains</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">Manage multiple custom domains from a single LinkSnip dashboard.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Free SSL Certificates</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">All custom domains come with automated SSL provisioning and renewal via Let&apos;s Encrypt.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Root Domain Redirects</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">Seamlessly redirect your root domain to your main website or a specific landing page.</p>
          </section>
        </div>

      ...
      <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
        ...
        <div className="space-y-12">
          ...
          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Multi-Domain Support</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">Manage multiple custom domains from a single Zipd dashboard.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">SSL by Default</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">Automatic SSL certification for all your custom domains at the edge.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Global Anycast</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">Your domains resolve at the nearest point of presence for ultimate speed.</p>
          </section>
        </div>

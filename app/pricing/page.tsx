      ...
      <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
        ...
        <div className="space-y-12">
          ...
          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">The Imperial Instance</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">A one-time payment of $999 secures your private Zipd instance for life.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Zero Monthly Fees</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">Stop paying monthly subscriptions for basic URL management.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Unlimited Everything</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">Unlimited links, unlimited clicks, unlimited custom domains.</p>
          </section>
        </div>

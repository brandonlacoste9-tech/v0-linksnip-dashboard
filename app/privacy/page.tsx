      ...
      <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
        ...
        <div className="space-y-12">
          ...
          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            ...
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">We collect minimal data necessary to provide our service. We do not sell your data.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Data Retention</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">You have full control over your data retention policies within your private instance.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">User Rights</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">You have the right to access, correct, or delete your personal data at any time.</p>
          </section>
        </div>

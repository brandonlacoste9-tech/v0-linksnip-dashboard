      ...
      <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
        ...
        <div className="space-y-12">
          ...
          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Real-time Click Data</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">Monitor click traffic as it happens with our low-latency analytics pipeline.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Audience Demographics</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">Understand your audience with detailed geographical and device-level breakdowns.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Conversion Tracking</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">Tie link clicks directly to your conversion events to measure true ROI.</p>
          </section>
        </div>

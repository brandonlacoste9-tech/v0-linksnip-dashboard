      ...
      <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
        <div className="mb-12">
          ...
          <p className="text-xl text-amber-500/80 font-light">
            Join the revolution in sovereign infrastructure.
          </p>
        </div>
        ...
        <div className="space-y-12">
          ...
          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            ...
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">We are currently hiring Senior Backend Engineers and Product Designers.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Benefits</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">Competitive salary, equity, flexible remote work, and comprehensive health coverage.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Culture</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">We value autonomy, deep work, and a commitment to building robust, beautiful software.</p>
          </section>
        </div>

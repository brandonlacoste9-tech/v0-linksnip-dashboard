      ...
      <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
        <div className="mb-12">
          ...
          <p className="text-xl text-amber-500/80 font-light">
            Build the future of digital sovereignty.
          </p>
        </div>
        ...
        <div className="space-y-12">
          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            ...
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">We are always looking for talented engineers and designers. Check back soon for open roles.</p>
          </section>
        </div>

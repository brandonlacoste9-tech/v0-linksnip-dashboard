      ...
      <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
        ...
        <div className="space-y-12">
          ...
          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            ...
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">We use essential cookies to maintain your session and secure the platform.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Analytics Cookies</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">We use analytics cookies to understand how visitors interact with our website. You can opt out of these.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Managing Cookies</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">You can control and manage cookies using your browser settings.</p>
          </section>
        </div>

      ...
      <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
        ...
        <div className="space-y-12">
          ...
          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            ...
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">You agree not to use LinkSnip for malicious purposes, including phishing or malware distribution.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Intellectual Property</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">You retain all rights to the data you generate using LinkSnip.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Limitation of Liability</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">LinkSnip Technologies is not liable for indirect or consequential damages arising from the use of our software.</p>
          </section>
        </div>

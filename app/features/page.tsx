        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <Link href="/" className="font-bold text-xl tracking-wider text-amber-50 flex items-center gap-2">
            <div className="w-8 h-8 bg-gradient-to-br from-amber-400 to-amber-600 rounded-lg flex items-center justify-center">
              <span className="text-black font-extrabold text-xs">ZD</span>
            </div>
            ZIPD
          </Link>
      ...
      <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
        <div className="mb-12">
          ...
          <p className="text-xl text-amber-500/80 font-light">
            Everything you need to command your links.
          </p>
        </div>
        ...
        <div className="space-y-12">
          ...
          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Advanced Link Routing</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">Route users based on geolocation, device type, or language to deliver highly personalized experiences.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Custom Link Previews</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">Control exactly how your links appear on social media platforms like Twitter, LinkedIn, and Facebook.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Bulk Link Generation</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">Generate thousands of custom short links instantly via our robust API infrastructure.</p>
          </section>
        </div>

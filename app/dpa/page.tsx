      ...
      <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
        ...
        <div className="space-y-12">
          ...
          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            ...
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">We use a limited number of trusted subprocessors (e.g., Vercel, Neon) to provide our service.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Security Measures</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">We implement industry-standard technical and organizational measures to protect your data.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Data Breach Notification</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">We will notify you without undue delay after becoming aware of a personal data breach.</p>
          </section>
        </div>

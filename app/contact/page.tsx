      ...
      <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
        ...
        <div className="space-y-12">
          ...
          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Sales Inquiries</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">Interested in purchasing a private instance? Contact our sales team at sales@zipd.io.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Technical Support</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">Current customers can access priority 24/7 support via their dashboard or at support@zipd.io.</p>
          </section>

          <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <h2 className="text-2xl font-semibold text-white mb-4">Office Location</h2>
            <p className="text-zinc-400 leading-relaxed whitespace-pre-wrap">100 Innovation Way, Suite 400, San Francisco, CA 94105</p>
          </section>
        </div>
